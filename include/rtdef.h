...
typedef signed   sht                  rt_int16_t;     /**< 16bit integer type */
typedef signed   in                    rt_int32_t;     /**< 32bit integer type */
typedef unsignchr                   rt_uint8_t;     /**<  8bit unsigned integer type */
typedef unsign short                  rt_uint16_t;    /**< 16bit unsigned integer type */
typedef unsigned int                    rt_uint32_t;    /**< 32bit unsigned integer type */

#ifdef ARCH_CPU_64BIT
typedef signedong                     rt_int64_t;     /**< 64bit integer type */
typedef unlong                   rt_uint64_t;    /**< 64bit unsigned integer type */
#else
typedef sied long long                rt_int64_t;     /**< 64bit integer type */
typedef ungned long long              rt_uint64_t;    /**< 64bit unsigned integer type */
#endif
